...
from CEDD.com.dao.ComplainDAO import ComplainDAO
from CEDD.com.vo.ComplainVO import ComplainVO
	...
	try:
		if LoginSession() == 'user':
			...
			try:
				...
				filepath = "CEDD/static/Dataset/Files/" + filename
	...
	try:
		if LoginSession() == 'admin':
			...
			try:
				...
				filename = filename.replace( '..', 'CEDD/' )
